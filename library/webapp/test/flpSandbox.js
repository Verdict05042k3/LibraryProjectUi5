			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5library-display": {
								"semanticObject": "ui5library",
								"action": "display",
								"description": "An Library Fiori application.",
								"title": "Library",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5.library",
									"url": sap.ui.require.toUrl("ui5/library")
								}
							}
						}
					}
